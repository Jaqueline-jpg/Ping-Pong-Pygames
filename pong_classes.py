...
class Game:
    ...
    #Esse código inicializa os módulos pygame e mixer, que são necessários para o funcionamento do jogo.
    def init_pygame(self):
        pygame.init()
        mixer.init()

        #O código define constantes para um jogo com as seguintes configurações: 
        #tela de largura 800 pixels e altura 600 pixels, paletas com largura 10 pixels e altura 60 pixels, 
        #bola com tamanho 10 pixels, velocidade das paletas de 4 e velocidade da bola de 5.
        ...
        #Esse código abaixo reproduz uma música em loop continuamente.
